        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Issues_ClientUsers_ClientUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssuesComments_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "AdminId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssuesComments_Issues_IssueId",
                        column: x => x.IssueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_ClientUserId",
                table: "Issues",
                column: "ClientUserId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuesComments_AdminId",
                table: "IssuesComments",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuesComments_IssueId",
                table: "IssuesComments",
                column: "IssueId");
        }
